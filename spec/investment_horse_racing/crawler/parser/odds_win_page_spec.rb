...
RSpec.describe InvestmentHorseRacing::Crawler::Parser::OddsWinPageParser do
  before do
    ...
    data = {
      ...
      "request_headers" => {},
      "response_headers" => {},
      "response_body" => File.open("spec/data/odds_win.20180624.hanshin.1.html").read,
      "downloaded_timestamp" => Time.utc(2018, 6, 24, 0, 0, 0)}

    @parser = InvestmentHorseRacing::Crawler::Parser::OddsWinPageParser.new(url, data)
    ...
    data = {
      ...
      "request_headers" => {},
      "response_headers" => {},
      "response_body" => File.open("spec/data/odds_win.00000000.error.html").read,
      "downloaded_timestamp" => Time.now}

    @parser_error = InvestmentHorseRacing::Crawler::Parser::OddsWinPageParser.new(url, data)
  end
