...
class SchedulePageTest < ActiveSupport::TestCase
  ...
  test "parse" do
    ...
    assert_equal "東京", race_list_page.cource_name
    ...
    assert_equal Time.zone.local(2018, 6, 2), race_list_page.date
    assert_equal "阪神", race_list_page.cource_name
    assert_not race_list_page.exists?
    assert_not race_list_page.valid?
    ...
    assert_equal "函館", race_list_page.cource_name
    assert_not race_list_page.exists?
    assert_not race_list_page.valid?
    ...
    assert_equal Time.zone.local(2018, 6, 30), race_list_page.date
    assert_equal "福島", race_list_page.cource_name
    assert_not race_list_page.exists?
    assert_not race_list_page.valid?
    ...
    assert_equal Time.zone.local(2018, 6, 30), race_list_page.date
    assert_equal "中京", race_list_page.cource_name
    assert_not race_list_page.exists?
    assert_not race_list_page.valid?
  end
  ...
  test "parse: case line skip" do
    ...
    assert_equal "札幌", race_list_page.cource_name
    assert_not race_list_page.exists?
    assert_not race_list_page.valid?
    ...
    assert_equal Time.zone.local(2018, 8, 4), race_list_page.date
    assert_equal "新潟", race_list_page.cource_name
    assert_not race_list_page.exists?
    assert_not race_list_page.valid?
    ...
    assert_equal Time.zone.local(2018, 8, 4), race_list_page.date
    assert_equal "小倉", race_list_page.cource_name
    assert_not race_list_page.exists?
    assert_not race_list_page.valid?
